...
parallel velocity dissipation $D_v(\vec{k})$ with, meaning that there is no net energy entering the system directly through the parallel velocity as expected. 
